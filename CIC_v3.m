...
fDir=fullfile(rootDir,'/FoodCues/FoodPics_ID432/Session3');
sDir=fullfile(rootDir,'/SocialCues/SocialPics_ID432/Session3');
cDir=fullfile(rootDir,'/ControlCues/ControlPics_ID432/Session3');
