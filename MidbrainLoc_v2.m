...
% functional localizer for dopaminergic midbrain (SN/VTA)
% duration: ~13min
% adapted from Krebs 2011
% input = e.g., MicbrainLoc_v1('SAX_SISO_01')
% changes to v1: now no loss condition, only reward vs. no-reward
